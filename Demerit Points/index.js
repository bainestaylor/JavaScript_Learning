...
function checkSpeed (speed) {
  ...
  if (speed <= 74) return console.log ('Ok'); //Add formula for calculating the acceptable speed from above variables
  ...
  //Add formula for calculating the point demerits
